      ...
      <div className='w-1/2'>
        ...
        {items.map((item) => (
          ...
          >
            ...
            <div className={`grid  ${role==="Consumer"?'grid-cols-1':'grid-cols-2'} `}>
            ...
            <p><span  className='text-xl font-semibold'>Damage: </span> {item.damage}</p>
            <p><span  className='text-xl font-semibold'>Manufactured Date: </span>{formatDate(item.manufacturedDate)}</p>
            
            {
            role==="Consumer" &&  <div className={'absolute right-[10%] bottom-[50%] translate-y-1/2'}>
            ...
            {
             role==="Consumer" && 
             <button onClick={() => viewItem(item._id)} className='bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 mt-4'>
              View Item
             </button> 
            }
          </div>
