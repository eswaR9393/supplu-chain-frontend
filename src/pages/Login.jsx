...
const Login = () => {
    ...
    const [credentials,setCredentials] = useState({email:'',password:'',role:'Manufacturer'});
  ...
  return (
    <div className='h-[100vh] w-[100vw] relative bg-[#016F83]'>
        ...
        <form className='p-8 w-[90%] md:w-[30%] bg-white rounded-xl z-50 absolute  left-[50%] translate-x-[-50%]  md:translate-x-[0%] md:left-[10%] top-[60%] md:top-[50%] translate-y-[-50%]' onSubmit={onsubmit}>
            ...
            <div className='flex justify-between items-center'>
                <h2 className='font-bold text-3xl text-[#6798FE]'>Login</h2>
                
            </div>
            <p className='mb-8 mt-2 text-gray-500 font-semibold'>Help keep the supply chain secure and transparent using blockchain. </p>
            ...
            <button className='bg-[#6798FE] hover:bg-[#3164d3] cursor-pointer text-white py-2 text-lg w-full rounded-xl mt-6 ' type='submit'>Login</button>
